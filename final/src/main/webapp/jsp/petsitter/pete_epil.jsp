...
<input type="hidden" value="${pete_board_num}" name="pete_board_num">
<table class="table table-bordered table-hover">
<tr>
	<td>회원 아이디 : <input type="text" name="pete_epil_id" id="pete_epil_id"
	 value="${pete_id}" style="border: none" readonly></td>
</tr>
<tr>
	<td>후기 작성자 : <input type="text" name="join_epil_id" id="join_epil_id" value="${sessionScope.id}" readonly
