...
public class BoardAction {
	...
	public ModelAndView write_board_pet(
		...
		mv.setViewName("board_pet_write");
		return mv;
	}
	...
	public ModelAndView modify_board_view(
		...
		mv.addObject("type",type);
		mv.setViewName("board_pet_modify");
	...
	public ModelAndView load_board_pet_content(
		...
		if(ajax.equals("ajax")) {
			mv.setViewName("ajax_reply_list");
		}else {
			mv.setViewName("board_pet_content");
		}
		return mv;
	}
	//일상 게시글 검색하기
	...
	public ModelAndView modify_board_reply(
		...
		mv.setViewName("ajax_reply_modify");
		return mv;
	}
	...
	public ModelAndView delete_board_reply(
		...
		mv.setViewName("ajax_reply_delete_write");
		return mv;	
	}
	...
	public ModelAndView board_myPage(
		...
		if(!fav_ajax.equals("none")) {
			mv.setViewName("ajax_board_mypage");		
		}else {
			mv.setViewName("board_mypage");
		}
		return mv;
	}
